...
import/websites/gr.maharashtra.gov.in/Tourism:
	cd import/websites/gr.maharashtra.gov.in/ && ln -s $(GR_DIR)/Tourism .
...
import: check_env import/websites/gr.maharashtra.gov.in/Tourism .secrets/google.token 
	poetry run python import/src/build_documents.py import/websites/gr.maharashtra.gov.in/Tourism import/documents
